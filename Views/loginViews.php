...
<header class="bd-header bg-transparent py-3 d-flex align-items-stretch border-bottom border-dark">
        <div class="container-fluid d-flex align-items-center">
            ...
            <a href="index.php" class="btn btn-outline-info ms-auto link-dark">Retourner à l'accueil</a>
        </div>
    </header>
<body>
    <form action="" method="POST" class="col-md-6 offset-md-3 mt-5">
        ...
        <div class="mb-3">
            <label for="inputEmail" class="form-label">Email l'utilisateur</label>
        ...
        <button  type="submit" class="btn btn-primary" name="create">Se connecter</button>
